...
jremove /mss/clas/e1e/production/simulation_2pi/gleb_2016/high_w/high_w${z}.root

if (!(-e /mss/clas/e1e/production/simulation_2pi/gleb_2016/high_w/high_w${z}.root)) then
