...
C-------------------------------------
	...
	q(1) = - E_EL*SIN(3.1416/180.*TH_EL)*COS(3.1416/180.*PH_EL)
	q(2) = - E_EL*SIN(3.1416/180.*TH_EL)*SIN(3.1416/180.*PH_EL)
	q(3) = E0 - E_EL*COS(3.1416/180.*TH_EL)
...
C------------------------------------------------------------------------
	...
	PPI1X1 = COS(3.1416/180.*PH_EL)*PPI1X + SIN(3.1416/180.*PH_EL)*PPI1Y
	PPI1Y1 = - SIN(3.1416/180.*PH_EL)*PPI1X + COS(3.1416/180.*PH_EL)*PPI1Y
	PPI1Z1 = PPI1Z
	...
	PPI2X1 = COS(3.1416/180.*PH_EL)*PPI2X + SIN(3.1416/180.*PH_EL)*PPI2Y
	PPI2Y1 = - SIN(3.1416/180.*PH_EL)*PPI2X + COS(3.1416/180.*PH_EL)*PPI2Y
	PPI2Z1 = PPI2Z
	...
	PNX1 = COS(3.1416/180.*PH_EL)*PNX + SIN(3.1416/180.*PH_EL)*PNY
	PNY1 = - SIN(3.1416/180.*PH_EL)*PNX + COS(3.1416/180.*PH_EL)*PNY
	PNZ1 = PNZ
