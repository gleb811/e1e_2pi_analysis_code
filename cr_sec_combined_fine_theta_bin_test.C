...
void cr_sec_combined_fine_theta_bin_test() {
#include <TH2.h>
#include <TH1.h>
#include <TH3.h>
#include <THnSparse.h>
...
TFile *file_sim = new TFile("haddmy/combine_fine_theta_bin.root","READ");
TFile *file_data = new TFile("haddmy/combine_data_fine_theta_bin.root","READ");
TFile *file_empty = new TFile("haddmy/combine_data_fine_theta_bin.root","READ");
...
err1 = (h_cr_sect_1[i]->GetBinContent(tmp_cr_sect1_bin))/sqrt(h_data_1_tmp[i]->GetBinContent(tmp_data1_bin));
err2 = (h_eff_1[i]->GetBinError(tmp_eff1_bin))/(h_eff_1[i]->GetBinContent(tmp_eff1_bin));
err2 = (h_cr_sect_1[i]->GetBinContent(tmp_cr_sect1_bin))*err2;

h_cr_sect_1[i]->SetBinError(tmp_cr_sect1_bin,sqrt(err1*err1+err2*err2));
} else {
...
err1 = (h_cr_sect_2[i]->GetBinContent(tmp_cr_sect2_bin))/sqrt(h_data_2_tmp[i]->GetBinContent(tmp_data2_bin));
err2 = (h_eff_2[i]->GetBinError(tmp_eff2_bin))/(h_eff_2[i]->GetBinContent(tmp_eff2_bin));
err2 = (h_cr_sect_2[i]->GetBinContent(tmp_cr_sect2_bin))*err2;
h_cr_sect_2[i]->SetBinError(tmp_cr_sect2_bin,sqrt(err1*err1+err2*err2));
...
err1 = (h_cr_sect_3[i]->GetBinContent(tmp_cr_sect3_bin))/sqrt(h_data_3_tmp[i]->GetBinContent(tmp_data3_bin));
err2 = (h_eff_3[i]->GetBinError(tmp_eff3_bin))/(h_eff_3[i]->GetBinContent(tmp_eff3_bin));
err2 = (h_cr_sect_3[i]->GetBinContent(tmp_cr_sect3_bin))*err2;
h_cr_sect_3[i]->SetBinError(tmp_cr_sect3_bin,sqrt(err1*err1+err2*err2));
