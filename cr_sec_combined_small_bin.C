...
tmp_eff1_bin = h_eff_1[i]->GetBin(bins);
tmp_eff2_bin = h_eff_2[i]->GetBin(bins);
tmp_eff3_bin = h_eff_3[i]->GetBin(bins);
...
if ((h_eff_1[i]->GetBinContent(bins) > 0.) && ((h_gen_1[i]->GetBinContent(bins)) > (h_rec_1[i]->GetBinContent(bins)))) {

err1 = (h_rec_1[i]->GetBinContent(bins))*((h_gen_1[i]->GetBinContent(bins))-(h_rec_1[i]->GetBinContent(bins)));
err1 = err1/(h_gen_1[i]->GetBinContent(bins))/(h_gen_1[i]->GetBinContent(bins))/(h_gen_1[i]->GetBinContent(bins));
err1 = sqrt(err1);
h_eff_1[i]->SetBinError(bins,err1);

};

if ((h_eff_2[i]->GetBinContent(bins) > 0.) && ((h_gen_2[i]->GetBinContent(bins)) > (h_rec_2[i]->GetBinContent(bins)))) {

err1 = (h_rec_2[i]->GetBinContent(bins))*((h_gen_2[i]->GetBinContent(bins))-(h_rec_2[i]->GetBinContent(bins)));
err1 = err1/(h_gen_2[i]->GetBinContent(bins))/(h_gen_2[i]->GetBinContent(bins))/(h_gen_2[i]->GetBinContent(bins));
err1 = sqrt(err1);
h_eff_2[i]->SetBinError(bins,err1);

};

if ((h_eff_3[i]->GetBinContent(bins) > 0.) && ((h_gen_3[i]->GetBinContent(bins)) > (h_rec_3[i]->GetBinContent(bins)))) {

err1 = (h_rec_3[i]->GetBinContent(bins))*((h_gen_3[i]->GetBinContent(bins))-(h_rec_3[i]->GetBinContent(bins)));
err1 = err1/(h_gen_3[i]->GetBinContent(bins))/(h_gen_3[i]->GetBinContent(bins))/(h_gen_3[i]->GetBinContent(bins));
err1 = sqrt(err1);
h_eff_3[i]->SetBinError(bins,err1);
