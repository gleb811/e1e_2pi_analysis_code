...
void cr_sec_combined_small_bin_phi() {
#include <TH2.h>
#include <TH1.h>
#include <TH3.h>
#include <THnSparse.h>
...
//h_prj_crs = h_cr_sect_noemptcells_2[i]->Projection(4,"");
h_prj_crs = empty_fill_err(h_cr_sect_2[i]->Projection(1,""),h_cr_sect_noemptcells_2[i]->Projection(1,""));
...
cout << "persentage of empty cells " << (((h_cr_sect_2[i]->Projection(4,""))->Integral())-((h_cr_sect_noemptcells_2[i]->Projection(4,""))->Integral()))/((h_cr_sect_2[i]->Projection(4,""))->Integral())*100. << endl;
...
draw_1d_hist(10,model_1[i]->Projection(3,""),"","model_phi_proton","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",3,"e1","alpha",i);

// phi proton

       draw_1d_hist(10,empty_fill_err(h_cr_sect_1[i]->Projection(3,""), h_cr_sect_noemptcells_1[i]->Projection(3,"")),"","phi_proton","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",1,"e1AP same","alpha",i);

// phi proton  no empty cells filling

draw_1d_hist(10, h_cr_sect_noemptcells_1[i]->Projection(3,""),"","phi_proton_noempt","d#sigma/d#varphi (#mubn/rad)","#varphi_{p'} (deg)",2,"e1AP same","alpha",i);


// phi pi- model

draw_1d_hist(11,model_2[i]->Projection(3,""),"","model_phi_pim","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",3,"e1","alpha",i);

// phi pi-

       draw_1d_hist(11,empty_fill_err(h_cr_sect_2[i]->Projection(3,""), h_cr_sect_noemptcells_2[i]->Projection(3,"")),"","phi_pim","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",1,"e1AP same","alpha",i);

// phi pi-  no empty cells filling

draw_1d_hist(11, h_cr_sect_noemptcells_2[i]->Projection(3,""),"","phi_pim_noempt","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{-}} (deg)",2,"e1AP same","alpha",i);


// phi pi+ model

draw_1d_hist(12,model_3[i]->Projection(3,""),"","model_phi_pip","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",3,"e1","alpha",i);

// phi pi+

       draw_1d_hist(12,empty_fill_err(h_cr_sect_3[i]->Projection(3,""), h_cr_sect_noemptcells_3[i]->Projection(3,"")),"","phi_pip","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",1,"e1AP same","alpha",i);

// phi pi+  no empty cells filling

draw_1d_hist(12, h_cr_sect_noemptcells_3[i]->Projection(3,""),"","phi_pip_noempt","d#sigma/d#varphi (#mubn/rad)","#varphi_{#pi^{+}} (deg)",2,"e1AP same","alpha",i);
