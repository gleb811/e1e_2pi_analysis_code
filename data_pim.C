...
draw_1d_hist(1,h_cr_sect_1[i]->Projection(0,""),qqq.str(),"h1prj_inv_m_pip_p_1_","N_{events}","m_{#pi^{+}p}, GeV",1,"e1","mass",i);
qqq.str("");
...
draw_1d_hist(2,h_cr_sect_1[i]->Projection(1,""),"","h1prj_inv_m_pip_pim_1_","N_{events}","m_{#pi^{+}#pi^{-}}, GeV",1,"e1","mass",i);
...
draw_1d_hist(3,h_cr_sect_3[i]->Projection(0,""),"","h3prj_inv_m_pim_p_1_","N_{events}","m_{#pi^{-}p}, GeV",1,"e1","mass",i);
...
draw_1d_hist(4,h_cr_sect_1[i]->Projection(2,""),"","h1prj_th_P_","N_{events}","#theta_{p'} in c.m., deg",1,"e1","theta",i);
...
draw_1d_hist(5,h_cr_sect_2[i]->Projection(2,""),"","h1prj_th_PIm_","N_{events}","#theta_{#pi^{-}} in c.m., deg",1,"e1","theta",i);
...
draw_1d_hist(6,h_cr_sect_3[i]->Projection(2,""),"","h1prj_th_PIp_","N_{events}","#theta_{#pi^{+}} in c.m., deg",1,"e1","theta",i);
...
draw_1d_hist(7,h_cr_sect_1[i]->Projection(4,""),"","h1prj_alpha_PIpPIm_pipf_","N_{events}","#alpha_{#pi^{+}#pi^{-}_pp'}, deg",1,"e1","alpha",i);
...
draw_1d_hist(8,h_cr_sect_2[i]->Projection(4,""),"","h2prj_alpha_PPIp_piPIm_","N_{events}","alpha_{p'#pi^{+}_p#pi^{-}}, deg",1,"e1","alpha",i);
...
draw_1d_hist(9,h_cr_sect_3[i]->Projection(4,""),"","h3prj_alpha_PPIm_piPIp_","N_{events}","#alpha_{p'#pi^{-}_p#pi^{+}}, deg",1,"e1","alpha",i);
