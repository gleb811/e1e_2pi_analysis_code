...
if (name == "h1prj_inv_m_pip_p_1_gen") leg->AddEntry(h,"GENEV","p");
...
qqq.str("");
 ...
 TH1D *gen_tmp = h_gen_1[i]->Projection(0,"");
 TH1D *model_tmp = model_1[i]->Projection(0,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(1,gen_tmp,"","h1prj_inv_m_pip_p_1_gen","d#sigma/dM, #mubn/GeV","m_{#pi^{+}p}, GeV",4,"AP0 same","mass",i);
qqq.str("");
 
// pi+ proton mass


draw_1d_hist(1,h_cr_sect_1[i]->Projection(0,""),"","h1prj_inv_m_pip_p_1_","d#sigma/dM, #mubn/GeV","m_{#pi^{+}p}, GeV",1,"e1AP same","mass",i);
qqq.str("");
...
draw_1d_hist(2,model_1[i]->Projection(1,""),"","model_pippim_1_","d#sigma/dM, #mubn/GeV","m_{#pi^{+}#pi^{-}}, GeV",3,"e1","mass",i);
 ...
 gen_tmp = h_gen_1[i]->Projection(1,"");
 model_tmp = model_1[i]->Projection(1,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(2,gen_tmp,"","h1prj_inv_m_pip_pim_1_gen","d#sigma/dM, #mubn/GeV","m_{#pi^{+}#pi^{-}}, GeV",4,"AP0 same","mass",i);
// pi+ pi- mass

draw_1d_hist(2,h_cr_sect_1[i]->Projection(1,""),"","h1prj_inv_m_pip_pim_1_","d#sigma/dM, #mubn/GeV","m_{#pi^{+}#pi^{-}}, GeV",1,"e1AP same","mass",i);
...
draw_1d_hist(3,model_3[i]->Projection(0,""),"","model_pimP_1_","d#sigma/dM, #mubn/GeV","m_{#pi^{-}p}, GeV",3,"e1","mass",i);
 ...
 gen_tmp = h_gen_3[i]->Projection(0,"");
 model_tmp = model_3[i]->Projection(0,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));
 
draw_1d_hist(3,gen_tmp,"","h3prj_inv_m_pim_p_1_gen","d#sigma/dM, #mubn/GeV","m_{#pi^{-}p}, GeV",4,"AP0 same","mass",i); 

// pi- proton mass

draw_1d_hist(3,h_cr_sect_3[i]->Projection(0,""),"","h3prj_inv_m_pim_p_1_","d#sigma/dM, #mubn/GeV","m_{#pi^{-}p}, GeV",1,"e1AP same","mass",i);
...
draw_1d_hist(4,model_1[i]->Projection(2,""),"","model_thetaP_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{p'} in c.m., deg",3,"e1","theta",i);
 ...
 gen_tmp = h_gen_1[i]->Projection(2,"");
 model_tmp = model_1[i]->Projection(2,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(4,gen_tmp,"","h1prj_th_P_gen","d#sigma/d(-cos#theta), #mubn/rad","#theta_{p'} in c.m., deg",4,"HIST P9 same","theta",i);
// theta proton

draw_1d_hist(4,h_cr_sect_1[i]->Projection(2,""),"","h1prj_th_P_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{p'} in c.m., deg",1,"e1AP same","theta",i);
...
draw_1d_hist(5,model_2[i]->Projection(2,""),"","model_thetapim_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{-}} in c.m., deg",3,"e1","theta",i);
 ...
 gen_tmp = h_gen_2[i]->Projection(2,"");
 model_tmp = model_2[i]->Projection(2,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(5,gen_tmp,"","h1prj_th_PIm_gen","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{-}} in c.m., deg",4,"HIST P9 same","theta",i);
// theta pi-

draw_1d_hist(5,h_cr_sect_2[i]->Projection(2,""),"","h1prj_th_PIm_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{-}} in c.m., deg",1,"e1AP same","theta",i);
...
draw_1d_hist(6,model_3[i]->Projection(2,""),"","model_thetapip_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{+}} in c.m., deg",3,"e1","theta",i);
 ...
 gen_tmp = h_gen_3[i]->Projection(2,"");
 model_tmp = model_3[i]->Projection(2,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));
 
 draw_1d_hist(6,gen_tmp,"","h1prj_th_PIp_gen","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{+}} in c.m., deg",4,"HIST P9 same","theta",i); 

// theta pi+

draw_1d_hist(6,h_cr_sect_3[i]->Projection(2,""),"","h1prj_th_PIp_","d#sigma/d(-cos#theta), #mubn/rad","#theta_{#pi^{+}} in c.m., deg",1,"e1AP same","theta",i);
...
draw_1d_hist(7,model_1[i]->Projection(4,""),"","model_alpha_proton_","d#sigma/d#alpha, #mubn/rad","#alpha_{#pi^{+}#pi^{-}_pp'}, deg",3,"e1","alpha",i);
 ...
 gen_tmp = h_gen_1[i]->Projection(4,"");
 model_tmp = model_1[i]->Projection(4,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(7,gen_tmp,"","h1prj_alpha_PIpPIm_pipf_gen","d#sigma/d#alpha, #mubn/rad","#alpha_{#pi^{+}#pi^{-}_pp'}, deg",4,"P0 same","alpha",i);

// alpha proton

draw_1d_hist(7,h_cr_sect_1[i]->Projection(4,""),"","h1prj_alpha_PIpPIm_pipf_","d#sigma/d#alpha, #mubn/rad","#alpha_{#pi^{+}#pi^{-}_pp'}, deg",1,"e1AP same","alpha",i);
...
draw_1d_hist(8,model_2[i]->Projection(4,""),"","model_alpha_pip_","d#sigma/d#alpha, #mubn/rad","alpha_{p'#pi^{+}_p#pi^{-}}, deg",3,"e1","alpha",i);
 ...
 gen_tmp = h_gen_2[i]->Projection(4,"");
 model_tmp = model_2[i]->Projection(4,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));
 
 draw_1d_hist(8,gen_tmp,"","h2prj_alpha_PPIp_piPIm_gen","d#sigma/d#alpha, #mubn/rad","alpha_{p'#pi^{+}_p#pi^{-}}, deg",4,"P0 same","alpha",i);

// alpha pi+

draw_1d_hist(8,h_cr_sect_2[i]->Projection(4,""),"","h2prj_alpha_PPIp_piPIm_","d#sigma/d#alpha, #mubn/rad","alpha_{p'#pi^{+}_p#pi^{-}}, deg",1,"e1AP same","alpha",i);
...
draw_1d_hist(9,model_3[i]->Projection(4,""),"","model_alpha_pim_","d#sigma/d#alpha, #mubn/rad","#alpha_{p'#pi^{-}_p#pi^{+}}, deg",3,"e1","alpha",i);
 ...
 gen_tmp = h_gen_3[i]->Projection(4,"");
 model_tmp = model_3[i]->Projection(4,"") ; 
 gen_tmp->Scale((model_tmp->GetMaximum())/(gen_tmp->GetMaximum()));

draw_1d_hist(9,gen_tmp,"","h3prj_alpha_PPIm_piPIp_gen","d#sigma/d#alpha, #mubn/rad","#alpha_{p'#pi^{-}_p#pi^{+}}, deg",4,"P0 same","alpha",i); 
// alpha pi-

draw_1d_hist(9,h_cr_sect_3[i]->Projection(4,""),"","h3prj_alpha_PPIm_piPIp_","d#sigma/d#alpha, #mubn/rad","#alpha_{p'#pi^{-}_p#pi^{+}}, deg",1,"e1AP same","alpha",i);
