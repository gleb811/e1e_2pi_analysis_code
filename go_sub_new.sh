...
echo "JOBNAME: run_w_low_145_155_${i}" >>jsub_new
...
echo "OUTPUT_TEMPLATE: /volatile/clas/clase1-6/gleb/2pi_analysis_e1e_new_bin/w_low_145_155_${i}.root" >>jsub_new





if (!(-e  /volatile/clas/clase1-6/gleb/2pi_analysis_e1e_new_bin/w_low_145_155_${i}.root)) then
