...
W_bin[i] = 1.3125+0.025*i; 
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/h_5dim_1_sim_1_q2_" << Q2_bin*1000 << "_w_" << 1000*W_bin[i];
gDirectory->GetObject(qqq.str().c_str(),tmp_rec1);
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/h_5dim_2_sim_1_q2_" << Q2_bin*1000 << "_w_" << 1000*W_bin[i];
gDirectory->GetObject(qqq.str().c_str(),tmp_rec2);
qqq.str("");
qqq << "q2_" << Q2_bin << "/w_" << W_bin[i] << "/h_5dim_3_sim_1_q2_" << Q2_bin*1000 << "_w_" << 1000*W_bin[i];
...
TFile *MyFile = new TFile("out_low_w_no_miss_pip.root","RECREATE");
MyFile->cd();
